...
(function() {
  ...
  AreaPanel.prototype = {
    createPanelArea: function() {
      ...
      let popupButton = this.panelButtonArea.getElementsByClassName('fm-editor-panel-area-popup-button')[0]
      popupButton.addEventListener('click', function(event) { panelAreaObj.toggleSections(event) })
      let moveDownButton = this.panelButtonArea.getElementsByClassName('fm-editor-panel-area-movedown-button')[0]
      moveDownButton.addEventListener('click', function(event) { panelAreaObj.scrollDownAreaBox() })
      let moveUpButton = this.panelButtonArea.getElementsByClassName('fm-editor-panel-area-moveup-button')[0]
...
(function() {
  ...
  ButtonPanel.prototype = {
    ...
    showSections: function(event) {
      ...
      this.active = true
      DomUtils.addClass(this.element, 'active')
      let finalWidth = this.buttonElement.getBoundingClientRect().left + this.sectionWidth
...
(function() {
  ...
  MlangPanel.prototype = {
    ...
    createList: function() {
      ...
      let latexSection = new ButtonSection({id: 'latex', name: 'LaTeX', children: []}, this)
      let latexItem = new DropdownListItem(latexSection, this)
      this.listItemContainer.appendChild(latexItem.element)
      let mmlSection = new ButtonSection({id: 'mml', name: 'MathML', children: []}, this)
